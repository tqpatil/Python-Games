#Name:Tanishq Patil
#Student ID:1961827
#Play around with svd image compression
...
img=mpimg.imread("C:\\Users\\tqpat\\OneDrive\\Documents\\Python\\octopus.jpg")        # you need to download the image from Canvas/Files/Labs
plt.imshow(img)
plt.show()
print(img.ndim)
...
# plt.imshow(red_approx, cmap="Blues")
plt.show()
